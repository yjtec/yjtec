...
function (_Component) {
  ...
  _createClass(LoginTab, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(TabPane, this.props, children);
    }
  }]);
...
var wrapContext = function wrapContext(props) {
  return _react.default.createElement(_LoginContext.default.Consumer, null, function (value) {
    return _react.default.createElement(LoginTab, _extends({
